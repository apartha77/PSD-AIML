...
MODEL_ENDPOINT = "jumpstart-dft-deepseek-llm-r1-disti-20250408-101531" # Change the endpoint
...
logger.info("Crew is set with Agents and tasks created")
